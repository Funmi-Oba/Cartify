<template>
  <article :class="['group', productsStore.productsPerRow === 1 ? 'md:flex md:gap-12' : '']">
    ...
    > -->
        ...
        :src="image"
        alt="product on sale"
        class="absolute inset-0 object-contain transition-all -translate-x1/2 -translate-y1/2 top1/2 left1/2 xl:scale90 aspect-9/11 size-full duration-900"
      /> -->
        <img
          :src="image"
          :alt="product.name || 'product image'"
          class="absolute inset-0 object-cover object-center w-full h-full transition-transform duration-500 ease-out group-hover:scale-105"
        />
        <!-- <img
        :src="image"
        alt="product on sale"
        class="absolute object-contain transition-all -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 size-4/5 duration-900 xl:scale-110"
      /> -->
        <!-- <img
        :src="image"
        alt="product on sale"
        class="object-contain size-1/2 scale-130 lg:scale-110"
      /> -->
